...
#Variables con palabras, arrays y numeros
...
#Funcion para pedir una letra del abecedario
def pedir_letra():
    letra_elegida = ''
    es_valida = False
...
#Funcion para agregar la letra al tablero
...
def chequear_letra(letra_elegida, palabra_oculta, vidas, coincidencias):
    ...
    if letra_elegida in palabra_oculta and letra_elegida not in letras_correctas:
      ...
      print('Ya has encontrado esa letra. Intente con otra diferente')
    else:
