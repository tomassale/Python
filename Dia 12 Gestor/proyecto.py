...
aplicacion = Tk()
aplicacion.geometry('1320x730+0+0')
...
# Lista de productos
lista_comidas = ['Pollo', 'Cordero', 'Salmon', 'Merluza', 'Kebab', 'Pizza', 'Empanada', 'Cerdo']
lista_bebidas = ['Agua', 'Jugo exprimido', 'Café', 'Té', 'Coca-Cola', 'Vino', 'Saborizada', 'Cerveza']
lista_postres = ['Helado', 'Tiramisú', 'Brownie', 'Flan', 'Mousse', 'Cheesecake', 'Torta', 'Muffin']
...
# Mantener aplicacion funcionando
aplicacion.mainloop()
